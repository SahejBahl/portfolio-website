    ...
    <div className="h-screen overflow-hidden bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-16 h-full overflow-hidden">
        ...
        <div className="space-y-6 text-base leading-relaxed mb-16">
          ...
          <p>
            Currently, I'm working as a SWE @ <a href="https://cloverlabs.ai/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Clover Labs</a>. Previously I was a SWE intern at <a href="https://rootly.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Rootly AI (YC S21)</a>, did open-source AI research with <a href="https://cohere.com/research" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Cohere Labs</a> and built healthcare-focused LLMs at <a href="https://www.hostalky.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Hostalky</a>.
          </p>
          <p>
