    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-base leading-relaxed mb-32">
          ...
          <p>
            Currently, I'm working as a Software + Product Engineering intern at <a href="https://rootly.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Rootly AI (YC S21)</a>, doing open-source AI research with <a href="https://cohere.com/research" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Cohere Labs</a>, building <a href="https://hitsmart.app/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">HitSmart</a> - a concussion recovery app, and creating <a href="https://www.instagram.com/sahej.eng" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">content</a>.
          </p>
          <p>
            My journey started when I was 13, I co-founded EnvironAI (backed by <a href="https://dmz.torontomu.ca/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">DMZ</a>), a waste-sorting app using AI for 94% accurate item classification, integrated with a chatbot and making recycling easier. That project made me fall in love with startups and building, and since then, I've worked on or for 9 startups, shipping real products across AI, health, and education.
          </p>
          <p>
